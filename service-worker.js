...
const CACHE_NAME = 'home-os-shell-v119';
...
const SHELL_FILES = [
  ...
  './js/views/pantry/browse.js',
  './js/views/pantry/fix.js',
  './js/views/pantry/useSoon.js',
  './js/views/pantry/add.js',
